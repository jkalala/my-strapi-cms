...
export interface ApiAdpadocumentAdpadocument
  extends Struct.CollectionTypeSchema {
  collectionName: 'adpadocuments';
  info: {
    description: '';
    displayName: 'documents';
    pluralName: 'adpadocuments';
    singularName: 'adpadocument';
  };
  options: {
...
export interface ApiBreakingNewsBreakingNews
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    publishedNewsAt: Schema.Attribute.Date;
